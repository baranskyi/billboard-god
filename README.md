...
### Для менеджерів:
- **[Інструкція для менеджера](MANAGER_GUIDE.md)** - повний гід по управлінню системою
- **[Шаблон навчання агентів](TRAINING_TEMPLATE.md)** - як навчати нових співробітників

### Для агентів:
- **[Інструкція для агентів](AGENT_GUIDE.md)** - детальний гід по роботі з системою
- **[Швидка довідка](AGENT_QUICK_REFERENCE.md)** - коротка памятка для друку

### Технічна документація:
- **[Швидкий старт](QUICK_START.md)** - запуск за 3 кроки
- **[Деплоймент](DEPLOYMENT.md)** - інструкції по розгортанню
